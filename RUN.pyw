...
DATA_FILE_HEADER = ['P_ID', 'Date', 'Time', 'Song_time', 'Arousal', 'Valence']
...
# Open dialog box to allow user to choose a sound file
file_dialog_box = Tk()
file_dialog_box.withdraw()
SOUND_FILE = tkFileDialog.askopenfilename()
...
# Get initial time at onset of music -- used later to derive song_time in secs
initial_time = time.time()
av_list = []  # list to hold lists of A/V data + times etc. (to be written to CSV)
